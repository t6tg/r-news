...
const Load = (props: Props) => {
  if (props.status === "load") {
    return (
      <div className="bg-green-700 bg-opacity-25 border-4 border-green-800 p-2 rounded-full ">
    ...
    return (
      <div className="bg-red-700 bg-opacity-25 border-4 border-red-800 p-2 rounded-full ">
